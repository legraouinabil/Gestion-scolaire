                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 v-if="edit" class="modal-title">
                                Edit formation
                            </h5>
...
export default {
    ...
    methods: {
        ...
        updateFormation() {
            axios
                .put(
                    "/api/admin/formation/update/" + this.formation.id,
                    this.formation
                )
                .then((res) => {
                    if (res.data.status == "error") {
        ...
        fetch() {
            axios
                .get("/api/admin/res-search", { params: { keywords: this.keywords } })
                .then((response) => {
                    this.formations = response.data;
                    console.log(response.data);
                })
